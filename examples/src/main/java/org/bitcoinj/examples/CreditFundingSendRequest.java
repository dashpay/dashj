 ...
 */
public class CreditFundingSendRequest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        NetworkParameters params = EvoNetParams.get();
        WalletAppKit kit = new WalletAppKit(params, new File("."), "creditfunding-sendrequest-example");
        kit.startAsync();
        kit.awaitRunning();
        ...
        try {
            ...
            org.bitcoinj.wallet.SendRequest sendRequest = org.bitcoinj.wallet.SendRequest.creditFundingTransaction(params, publicKey, fundingAmount);
