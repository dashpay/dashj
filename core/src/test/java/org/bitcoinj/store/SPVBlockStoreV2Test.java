...
public class SPVBlockStoreV2Test {
    ...
    public void setup() throws Exception {
        blockStoreFile = File.createTempFile("SPVBlockStoreV2", null);
    ...
    public void basics() throws Exception {
        SPVDirectIOBlockStore store = new SPVDirectIOBlockStore(UNITTEST, blockStoreFile);
        ...
        store = new SPVDirectIOBlockStore(UNITTEST, blockStoreFile);
    ...
    public void twoStores_sequentially_butMismatchingCapacity() throws Exception {
        SPVDirectIOBlockStore store = new SPVDirectIOBlockStore(UNITTEST, blockStoreFile, 10, false);
        store.close();
        store = new SPVDirectIOBlockStore(UNITTEST, blockStoreFile, 20, false);
    }

    @Test
    public void twoStores_sequentially_grow() throws Exception {
        Address to = Address.fromKey(UNITTEST, new ECKey());
        SPVDirectIOBlockStore store = new SPVDirectIOBlockStore(UNITTEST, blockStoreFile, 10, true);
        ...
        store = new SPVDirectIOBlockStore(UNITTEST, blockStoreFile, 20, true);
        ...
        store.close();
        assertEquals(SPVDirectIOBlockStore.getFileSize(20), blockStoreFile.length());
    }

    @Test(expected = BlockStoreException.class)
    public void twoStores_sequentially_shrink() throws Exception {
        SPVDirectIOBlockStore store = new SPVDirectIOBlockStore(UNITTEST, blockStoreFile, 20, true);
        store.close();
        store = new SPVDirectIOBlockStore(UNITTEST, blockStoreFile, 10, true);
    }
