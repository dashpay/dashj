...
public class CoinJoinStatusUpdateTest {
    ...
    public void statusUpdatePayloadTest() {
        ...
        CoinJoinStatusUpdate customStatusUpdate = new CoinJoinStatusUpdate(PARAMS, payload, PARAMS.getDefaultSerializer().withProtocolVersion(NetworkParameters.ProtocolVersion.BLS_LEGACY.getBitcoinProtocolVersion()));
        ...
        customStatusUpdate = new CoinJoinStatusUpdate(PARAMS, payload, PARAMS.getDefaultSerializer().withProtocolVersion(NetworkParameters.ProtocolVersion.BLS_LEGACY.getBitcoinProtocolVersion()));
    ...
    public void updateStatusTest() {
        ...
        CoinJoinStatusUpdate statusUpdateFromHex = new CoinJoinStatusUpdate(PARAMS, payload, PARAMS.getDefaultSerializer().withProtocolVersion(NetworkParameters.ProtocolVersion.BLS_LEGACY.getBitcoinProtocolVersion()));
