...
public class ScriptTest {
    ...
    public void testCreateMultiSigInputScript() {
        ...
        Address address = Address.fromBase58(TESTNET, "926m8DLgCuFUPATZ4oMkciXbnzHHfC3HoB");
    ...
    public void dataDrivenScripts() throws Exception {
        ...
        for (JsonNode test : json) {
            ...
            try {
                ...
                scriptSig.correctlySpends(txSpend, 0, null, scriptPubKey, verifyFlags);
        ...
        for (JsonNode test : json) {
            ...
            try {
                ...
                for (int i = 0; i < transaction.getInputs().size(); i++) {
                    ...
                    input.getScriptSig().correctlySpends(transaction, i, null, scriptPubKeys.get(input.getOutpoint()),
                            verifyFlags);
                }
            } catch (Exception e) {
                System.err.println(test);
