...
public class FilteredBlockAndPartialMerkleTreeTests extends TestWithPeerGroup {
    ...
    public void setUp() throws Exception {
        ...
        store.put(new StoredBlock(new Block(PARAMS, HEX.decode("000000200c0369a0bcefc11799c05b88b0835b4c994cdf09a377e3a013e799ac4e000000bf4439ee53c8a23e95ecd7046ffcf53a2cf5d76403cd13db1666a290541fac8939662358c851011eb7ec1201")),
                BigInteger.valueOf(1), 100000));
        store.setChainHead(store.get(Sha256Hash.wrap("0000005faad4f2a1fae2e0669cf5de2873fd261d90ddec9ab94476b26d0065af")));
    ...
    public void serializeDownloadBlockWithWallet() throws Exception {
        ...
        // Block 100001
        assertTrue(block.getHash().equals(Sha256Hash.wrap("50a05d9723b72d39c687aa546bad35d27c2c8477d1618e7615d9d9c6f4c8f31a")));
