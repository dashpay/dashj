...
*/
    ...
    public void providerRegistrationTest() throws IOException {
        ...
        ECKey inputPrivateKey0 = wallet.findKeyFromPubHash(Address.fromBase58(PARAMS, inputAddress0).getHash());
        ...
        ECKey collateralKey = wallet.findKeyFromPubHash(Address.fromBase58(PARAMS, collateralAddress).getHash());
        ECKey collateralAccount = wallet.findKeyFromPubHash(Address.fromBase58(PARAMS, collateralAddress).getHash());
        ECKey inputPrivateKey = wallet.findKeyFromPubHash(Address.fromBase58(PARAMS, inputAddress0).getHash());
    ...
    public void testNoCollateralProviderRegistrationTransaction() throws IOException {
        ...
        ECKey inputPrivateKey0 = wallet.findKeyFromPubHash(Address.fromBase58(PARAMS, inputAddress0).getHash());
        ECKey inputPrivateKey1 = wallet.findKeyFromPubHash(Address.fromBase58(PARAMS, inputAddress1).getHash());
        ECKey inputPrivateKey2 = wallet.findKeyFromPubHash(Address.fromBase58(PARAMS, inputAddress2).getHash());
