...
public class CoinDefinition {
    ...
    public static final String testnetGenesisHash = "0x5e039e1ca1dbf128973bf6cff98169e40a1b194c3b91463ab74956f413b2f9c8";
    ...
    public static final int GetBlockReward(int height)
    {
        int COIN = 1;
        int nSubsidy = 15 * COIN;
        ...
        {
            return nSubsidy >> (height / 4730400);
        }
        return nSubsidy;
    }
