...
package com.google.digitalcoin.kits;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV digitalcoinj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit digitalcoinj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing digitalcoinj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the digitalcoinj website for further details.
     */
