...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
    ...
    private volatile int vMinRequiredProtocolVersion = CoinDefinition.supportsBloomFiltering ? FilteredBlock.MIN_PROTOCOL_VERSION : CoinDefinition.MIN_PROTOCOL_VERSION;  //
