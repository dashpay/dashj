...
public interface KeyFactory {
    ...
    // Deterministic Keys
    IDeterministicKey fromExtended(List<ChildNumber> immutablePath, byte [] chainCode, byte[] pubkey, byte [] priv, IDeterministicKey parent);
    IDeterministicKey fromExtendedEncrypted(List<ChildNumber> immutablePath, byte [] chainCode, KeyCrypter keyCrypter, byte[] pubkey, EncryptedData data, IDeterministicKey parent);
    ...
    IDeterministicKey deserializeB58(String base58, List<ChildNumber> path, NetworkParameters params);
