...
public class TransactionSignature extends ECKey.ECDSASignature {
     ...
     * Because Dash Core works via bit testing, we must not lose the exact value when round-tripping
     ...
     * Dash Core. DER and the SIGHASH encoding allow for quite some flexibility in how the same structures
    ...
    public static boolean isEncodingCanonical(byte[] signature) {
        // See Dash Core's IsCanonicalSignature, https://bitcointalk.org/index.php?topic=8392.msg127623#msg127623
