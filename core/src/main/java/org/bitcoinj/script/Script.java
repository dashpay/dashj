...
public class Script {
    ...
    public enum ScriptType {
        ...
        ASSETLOCK(6); // pay to credit system
    ...
    public Address getToAddress(NetworkParameters params, boolean forcePayToPubKey) throws ScriptException {
        if (ScriptPattern.isP2PKH(this))
            return Address.fromPubKeyHash(params, ScriptPattern.extractHashFromP2PKH(this));
        else if (ScriptPattern.isP2SH(this))
            return Address.fromScriptHash(params, ScriptPattern.extractHashFromP2SH(this));
        else if (forcePayToPubKey && ScriptPattern.isP2PK(this))
            return Address.fromKey(params, ECKey.fromPublicOnly(ScriptPattern.extractKeyFromP2PK(this)));
        else
     ...
     * @param scriptPubKey The connected scriptPubKey containing the conditions needed to claim the value.
     * @param verifyFlags Each flag enables one validation rule.
     * @deprecated Use {@link #correctlySpends(Transaction, int, Coin, Script, Set)} instead.
     */
