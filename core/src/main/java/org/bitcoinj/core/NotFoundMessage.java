...
public class NotFoundMessage extends InventoryMessage {
    public static int MIN_PROTOCOL_VERSION = NetworkParameters.ProtocolVersion.MINIMUM.getBitcoinProtocolVersion(); //Use minimum Dash Protocol Version (for unit tests)
