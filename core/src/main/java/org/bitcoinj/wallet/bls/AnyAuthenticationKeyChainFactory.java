 ...
 */
public class AnyAuthenticationKeyChainFactory implements AnyKeyChainFactory {
    ...
    public AnyDeterministicKeyChain makeKeyChain(Protos.Key key, Protos.Key firstSubKey, DeterministicSeed seed,
        ...
        AnyAuthenticationKeyChain chain;
        if (isMarried) {
            throw new UnsupportedOperationException();
        } else {
            chain = new AnyAuthenticationKeyChain(seed, crypter, accountPath, keyFactory);
        }
        return chain;
    }
